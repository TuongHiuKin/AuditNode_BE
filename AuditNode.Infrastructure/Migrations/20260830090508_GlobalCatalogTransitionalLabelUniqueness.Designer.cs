...
namespace AuditNode.Infrastructure.Migrations
{
    ...
    [Migration("20260830090508_GlobalCatalogTransitionalLabelUniqueness")]
    partial class GlobalCatalogTransitionalLabelUniqueness
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AuditNode.Domain.Entities.Label", b =>
                {
                    ...
                    b.HasIndex("WorkspaceId", "OwnerUserId", "Key", "Value")
                        .IsUnique();
