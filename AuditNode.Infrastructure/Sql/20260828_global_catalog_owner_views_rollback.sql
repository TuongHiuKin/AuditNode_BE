-- Executable rollback for 20260828_global_catalog_owner_views.sql.
-- DROP VIEW intentionally uses PostgreSQL's default RESTRICT behavior: rollback fails
-- closed when an unknown dependent object exists instead of cascading data-model loss.
